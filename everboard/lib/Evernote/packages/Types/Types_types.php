...
$GLOBALS['edam_type_E_PrivilegeLevel'] = array(
  'NORMAL' => 1,
  'PREMIUM' => 3,
  'MANAGER' => 7,
  'SUPPORT' => 8,
...
$GLOBALS['edam_type_E_QueryFormat'] = array(
  'USER' => 1,
  'SEXP' => 2,
);

final class edam_type_QueryFormat {
  const USER = 1;
  const SEXP = 2;
  static public $__names = array(
    1 => 'USER',
...
$GLOBALS['edam_type_E_NoteSortOrder'] = array(
  'CREATED' => 1,
  'UPDATED' => 2,
  'RELEVANCE' => 3,
...
final class edam_type_NoteSortOrder {
  const CREATED = 1;
  const UPDATED = 2;
  const RELEVANCE = 3;
...
$GLOBALS['edam_type_E_PremiumOrderStatus'] = array(
  'NONE' => 0,
  'PENDING' => 1,
  'ACTIVE' => 2,
  'FAILED' => 3,
...
final class edam_type_PremiumOrderStatus {
  const NONE = 0;
  const PENDING = 1;
  const ACTIVE = 2;
  const FAILED = 3;
...
class edam_type_UserAttributes {
  static $_TSPEC;
      ...
      switch ($fid)
      {
        ...
        case 15:
          if ($ftype == TType::STRUCT) {
            $this->attributes = new edam_type_UserAttributes();
        ...
        case 16:
          if ($ftype == TType::STRUCT) {
            $this->accounting = new edam_type_Accounting();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 9:
          if ($ftype == TType::STRUCT) {
            $this->recognition = new edam_type_Data();
        ...
        case 11:
          if ($ftype == TType::STRUCT) {
            $this->attributes = new edam_type_ResourceAttributes();
            $xfer += $this->attributes->read($input);
          } else {
            $xfer += $input->skip($ftype);
          }
        ...
        case 13:
          if ($ftype == TType::STRUCT) {
            $this->alternateData = new edam_type_Data();
  ...
  public function read($input)
  {
    ...
    while (true)
    {
      ...
      switch ($fid)
      {
        ...
        case 10:
          if ($ftype == TType::STRUCT) {
            $this->publishing = new edam_type_Publishing();
