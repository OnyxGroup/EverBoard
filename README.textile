...
h2. Project Info
* *Web:* "http://onyxcreates.com/everboard" : http://onyxcreates.com/everboard
...
You will need to add/modify some of the things in the @config.php@ file. You will need to add the following which you can get by registering for an Evernote API key:
...
*NOTE: Do not store any sensitive information in any of the valid_notebooks because all the information will
be accessible on the web-server.*
